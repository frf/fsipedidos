...
abstract class BaseColaboradorPeer
{
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('CoColaborador', 'DsEmail', 'TpAdministrador', 'DsTelefone', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('coColaborador', 'dsEmail', 'tpAdministrador', 'dsTelefone', ),
        BasePeer::TYPE_COLNAME => array (ColaboradorPeer::CO_COLABORADOR, ColaboradorPeer::DS_EMAIL, ColaboradorPeer::TP_ADMINISTRADOR, ColaboradorPeer::DS_TELEFONE, ),
        BasePeer::TYPE_RAW_COLNAME => array ('CO_COLABORADOR', 'DS_EMAIL', 'TP_ADMINISTRADOR', 'DS_TELEFONE', ),
        BasePeer::TYPE_FIELDNAME => array ('co_colaborador', 'ds_email', 'tp_administrador', 'ds_telefone', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('CoColaborador' => 0, 'DsEmail' => 1, 'TpAdministrador' => 2, 'DsTelefone' => 3, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('coColaborador' => 0, 'dsEmail' => 1, 'tpAdministrador' => 2, 'dsTelefone' => 3, ),
        BasePeer::TYPE_COLNAME => array (ColaboradorPeer::CO_COLABORADOR => 0, ColaboradorPeer::DS_EMAIL => 1, ColaboradorPeer::TP_ADMINISTRADOR => 2, ColaboradorPeer::DS_TELEFONE => 3, ),
        BasePeer::TYPE_RAW_COLNAME => array ('CO_COLABORADOR' => 0, 'DS_EMAIL' => 1, 'TP_ADMINISTRADOR' => 2, 'DS_TELEFONE' => 3, ),
        BasePeer::TYPE_FIELDNAME => array ('co_colaborador' => 0, 'ds_email' => 1, 'tp_administrador' => 2, 'ds_telefone' => 3, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
    );
