 ...
 *
 * @method ColaboradorQuery leftJoinPedido($relationAlias = null) Adds a LEFT JOIN clause to the query using the Pedido relation
 * @method ColaboradorQuery rightJoinPedido($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Pedido relation
 * @method ColaboradorQuery innerJoinPedido($relationAlias = null) Adds a INNER JOIN clause to the query using the Pedido relation
 *
...
abstract class BaseColaboradorQuery extends ModelCriteria
{
    ...
    public function filterByPedido($pedido, $comparison = null)
    {
        if ($pedido instanceof Pedido) {
            return $this
                ->addUsingAlias(ColaboradorPeer::CO_COLABORADOR, $pedido->getCoColaborador(), $comparison);
