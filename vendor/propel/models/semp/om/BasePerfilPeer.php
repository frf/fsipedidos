...
abstract class BasePerfilPeer
{
    ...
    const CO_PERFIL = 'perfil.co_perfil';

    /** the column name for the no_perfil field */
    const NO_PERFIL = 'perfil.no_perfil';

    /** the column name for the ds_perfil field */
    const DS_PERFIL = 'perfil.ds_perfil';

    /** the column name for the st_perfil field */
    const ST_PERFIL = 'perfil.st_perfil';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('CoPerfil', 'NoPerfil', 'DsPerfil', 'StPerfil', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('coPerfil', 'noPerfil', 'dsPerfil', 'stPerfil', ),
        BasePeer::TYPE_COLNAME => array (PerfilPeer::CO_PERFIL, PerfilPeer::NO_PERFIL, PerfilPeer::DS_PERFIL, PerfilPeer::ST_PERFIL, ),
        BasePeer::TYPE_RAW_COLNAME => array ('CO_PERFIL', 'NO_PERFIL', 'DS_PERFIL', 'ST_PERFIL', ),
        BasePeer::TYPE_FIELDNAME => array ('co_perfil', 'no_perfil', 'ds_perfil', 'st_perfil', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('CoPerfil' => 0, 'NoPerfil' => 1, 'DsPerfil' => 2, 'StPerfil' => 3, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('coPerfil' => 0, 'noPerfil' => 1, 'dsPerfil' => 2, 'stPerfil' => 3, ),
        BasePeer::TYPE_COLNAME => array (PerfilPeer::CO_PERFIL => 0, PerfilPeer::NO_PERFIL => 1, PerfilPeer::DS_PERFIL => 2, PerfilPeer::ST_PERFIL => 3, ),
        BasePeer::TYPE_RAW_COLNAME => array ('CO_PERFIL' => 0, 'NO_PERFIL' => 1, 'DS_PERFIL' => 2, 'ST_PERFIL' => 3, ),
        BasePeer::TYPE_FIELDNAME => array ('co_perfil' => 0, 'no_perfil' => 1, 'ds_perfil' => 2, 'st_perfil' => 3, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
    );
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(PerfilPeer::CO_PERFIL);
            $criteria->addSelectColumn(PerfilPeer::NO_PERFIL);
            $criteria->addSelectColumn(PerfilPeer::DS_PERFIL);
            $criteria->addSelectColumn(PerfilPeer::ST_PERFIL);
        } else {
            $criteria->addSelectColumn($alias . '.co_perfil');
            $criteria->addSelectColumn($alias . '.no_perfil');
            $criteria->addSelectColumn($alias . '.ds_perfil');
            $criteria->addSelectColumn($alias . '.st_perfil');
        }
    }
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($criteria->containsKey(PerfilPeer::CO_PERFIL) && $criteria->keyContainsValue(PerfilPeer::CO_PERFIL) ) {
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $comparison = $criteria->getComparison(PerfilPeer::CO_PERFIL);
            $value = $criteria->remove(PerfilPeer::CO_PERFIL);
            if ($value) {
                $selectCriteria->add(PerfilPeer::CO_PERFIL, $value, $comparison);
            } else {
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(PerfilPeer::CO_PERFIL, (array) $values, Criteria::IN);
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        $criteria = new Criteria(PerfilPeer::DATABASE_NAME);
        $criteria->add(PerfilPeer::CO_PERFIL, $pk);
    ...
    public static function retrieveByPKs($pks, PropelPDO $con = null)
    {
        ...
        if (empty($pks)) {
            ...
            $criteria = new Criteria(PerfilPeer::DATABASE_NAME);
            $criteria->add(PerfilPeer::CO_PERFIL, $pks, Criteria::IN);
